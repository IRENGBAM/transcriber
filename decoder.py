...
st.set_page_config(page_title="Speech to Text Transcription", page_icon="🎤")
...
st.text("")
st.image(
    "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/google/263/microphone_1f3a4.png",
    width=125,
)
...
if f is not None:
    ...
    if getsize < 5:  # File more than 5 MB
        ...
        api_token = st.secrets["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"]
